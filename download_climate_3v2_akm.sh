...
#include_list="--exclude=*BIG* --include=${gcm}*_hurs_* --include=${gcm}*_pr_* --include=${gcm}*_rsds_* --include=${gcm}*_sfcwind_* --include=${gcm}*_tas_* --include=${gcm}*_tasmax_* --include=${gcm}*_tasmin_*"
#include_list="--exclude=*picontrol* --exclude=*BIG* --include=${gcm}*_hurs_* --include=${gcm}*_pr_* --include=${gcm}*_rsds_* --include=${gcm}*_sfcwind_* --include=${gcm}*_tas_* --include=${gcm}*_tasmax_* --include=${gcm}*_tasmin_*"
#include_list="--exclude=*BIG* --include=${gcm}*historical_tasmax_* --include=${gcm}*historical_tasmin_*"
include_list="--exclude=*BIG* --include=*gfdl*historical_rsds* --include=*ipsl*historical_tasmin_* --include=*mpi*picontrol_tasm* --exclude=*mri*ssp370* --include=*mri* --include=*ukesm*picontrol*"
...
#   #rsync -ahm --dry-run -v --info=progress2 --partial ${include_list} --include="*/*/" --include="*/" --exclude="*" midway:${remote_dir_top} .
   ...
   rsync -ahm --dry-run -v --info=progress2 --ignore-existing  ${include_list} --include="**/" --exclude="*" midway:${remote_dir_top} .
   echo " "
